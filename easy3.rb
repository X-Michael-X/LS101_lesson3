...
# my answer was advice.split[0..7].join(' ') + ' '
advice.slice!(0..38)
...
# The action remains the same but advice is not longer mutated
...
# Back in the stone age (before CSS) we used spaces to align things on the screen. If we had a 
# 40 character wide table of Flintstone family members, how could we easily center that title 
